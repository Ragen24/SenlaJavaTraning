...
public class ExecutedOrdersSortedByDateAction extends AbstractAction {
    private static Logger logger = LogManager.getLogger(ExecutedOrdersSortedByDateAction.class);

    public ExecutedOrdersSortedByDateAction(MenuConstants name, Integer id) {
        super(name, id);
    }
